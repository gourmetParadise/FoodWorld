...
function initProvinceCity(provinceSel, citySel) {
  ...
  provinceSel.change(function () {
    ...
    p = this.value;
    proSelected = Items[0][p - 1].split(":")[1];
  });
  citySel.change(function () {
    citySelected = Items[p][this.value - 1].split(":")[1];
  });
...
$(function () {
  ...
  $("#updateBtn").click(function () {
    ...
    var nativePlace = $("#p1").find("option:checked").text() + "," + $("#c1").find("option:checked").text();
    var userCareer = $("#jobs").val();
    /*console.log(userNickName + userSex + userSign + birthDate + nativePlace + userCareer);*/
